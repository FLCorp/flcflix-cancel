...
document.addEventListener('DOMContentLoaded', function() {
  // Sélectionner le bouton et la popup
  var showPopupButtonMobile = document.getElementById('showPopupButtonMobile');
  var popupMobile = document.getElementById('popup');
  var closeButtonMobile = document.getElementById('closeButton');
